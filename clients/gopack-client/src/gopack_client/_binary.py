"""Platform detection, download, and caching of the native gopack binary."""
...
def _binary_name() -> str:
    return "gopack.exe" if os.name == "nt" else "gopack"
...
def _cache_dir(version: str) -> Path:
    ...
    return Path(base) / "gopack-client" / version
